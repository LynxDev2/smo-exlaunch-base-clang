...
if (NOT EXISTS "${TOOLS_DIR}/clang/bin/clang${EXE_EXT}")
  ...
  elseif(DARWIN)
    message(FATAL_ERROR "Please download the clang toolchain from: https://github.com/ARM-software/LLVM-embedded-toolchain-for-Arm/releases/download/release-19.1.1/LLVM-ET-Arm-19.1.1-Darwin-universal.dmg and put the toolchain in tools/clang")
  else()
...
if (NOT EXISTS "${TOOLS_DIR}/linkle${EXE_EXT}")
  ...
  elseif (DARWIN)
    set(LINKLE_DOWNLOAD_URL "https://github.com/MegatonHammer/linkle/releases/download/v0.2.11/linkle-refs.tags.v0.2.11-x86_64-apple-darwin.zip")
  else()
    message(FATAL_ERROR "Unsupported platform! Only Windows and Linux are supported.")
  endif()
...
if (DARWIN)
  message("Skipping curl download because macos was detected as host")
elseif(NOT EXISTS "${TOOLS_DIR}/curl")
  if (WIN32)
